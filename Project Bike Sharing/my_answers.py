...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #output_error = self.activation_function(np.dot(delta_weights_h_o,final_outputs))
...
#         output_error_term = error * final_outputs * (1-final_outputs)
    ...
    def run(self, features):
        ...
        hidden_outputs = self.activation_function(np.dot(hidden_inputs,self.weights_input_to_hidden)) # signals from hidden layer # signals from hidden layer
        
        # TODO: Output layer - Replace these values with the appropriate calculations.
        final_inputs = hidden_outputs # signals into final output layer
        final_outputs = (np.dot(final_inputs,self.weights_hidden_to_output)) # signals from final output layer # signals from final output layer 
